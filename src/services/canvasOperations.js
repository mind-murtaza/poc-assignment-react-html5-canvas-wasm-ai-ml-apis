/**
 * Canvas Drawing and Image Operations Module
 * Separate module for all canvas drawing and image manipulation functions
 */
 ...
 * @param {Object} command - Command object with shape, color, position, size
 */
export const drawShape = (ctx, canvas, command) => {
	...
	switch (shape) {
		...
		case "rectangle":
			...
			ctx.fillRect(rectX, rectY, scaledSize, scaledSize * 0.6);
 ...
 * @param {CanvasRenderingContext2D} ctx - Canvas context
 * @param {HTMLCanvasElement} canvas - Canvas element
 * @param {Object} command - Command object with adjustment type and value
 */
